...
HD_PWD='C:/Users/tengk/mlp_HLS/mlp_HLS.runs/design_3_zynq_ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_3_zynq_ultra_ps_e_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_3_zynq_ultra_ps_e_0_0.tcl
