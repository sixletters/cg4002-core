...
// ==============================================================
#ifndef __mlp_HLS_fcmp_32nsjbC__HH__
#define __mlp_HLS_fcmp_32nsjbC__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mlp_HLS_fcmp_32nsjbC) {
    ...
    SC_CTOR(mlp_HLS_fcmp_32nsjbC):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
